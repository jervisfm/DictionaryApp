...
public class Dict extends AsyncTask<String, String, String> {
	...
	protected void onPostExecute(String result) {
		...
		Toast.makeText(ctx, "DONEEEE", Toast.LENGTH_SHORT).show();
		ctx.updateUI(result);
	}
